...
use crate::definitions_t::{
    ...
    candidate_mapping_overlaps_existing_vmem, L1_ENTRY_SIZE, L2_ENTRY_SIZE, MAX_BASE, PT_BOUND_LOW,
};
use crate::definitions_t::{PageTableEntry, L3_ENTRY_SIZE, MAX_PHYADDR, PT_BOUND_HIGH};
